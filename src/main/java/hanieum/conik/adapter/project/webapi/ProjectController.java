...
public class ProjectController {
    ...
    @AuthorizeUser(sourceType = AuthSourceType.PATH_VARIABLE, paramName = "memberId")
    public ApiResponse<Long> initProject(@AuthenticationPrincipal AuthDetails authDetails,
    ...
    @AuthorizeUser(sourceType = AuthSourceType.PATH_VARIABLE, paramName = "memberId")
    public ApiResponse<ProjectRegisterRequest> saveProjectTemp(@AuthenticationPrincipal AuthDetails authDetails,
    ...
    @AuthorizeUser(sourceType = AuthSourceType.PATH_VARIABLE, paramName = "memberId")
    public ApiResponse<ProjectRegisterRequest> saveProjectFinal(@AuthenticationPrincipal AuthDetails authDetails,
                                                                @PathVariable("projectId") Long projectId,
    ...
    @GetMapping("/{memberId}")
    @AuthorizeUser(sourceType = AuthSourceType.PATH_VARIABLE, paramName = "memberId")
    public ApiResponse<List<MemberProjectQueryResponse>> getMemberProjects(@AuthenticationPrincipal AuthDetails authDetails,
