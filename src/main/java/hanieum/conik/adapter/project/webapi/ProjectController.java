...
public class ProjectController {
    ...
    @PostMapping("/draft")
    public ApiResponse<ProjectRegisterRequest> saveProjectTemp(@RequestParam("member_id") Long memberId,
                                          @RequestBody ProjectRegisterRequest projectRegisterRequest) {
        return ApiResponse.success(projectSaver.saveProjectDraft(memberId, projectRegisterRequest));
    }
