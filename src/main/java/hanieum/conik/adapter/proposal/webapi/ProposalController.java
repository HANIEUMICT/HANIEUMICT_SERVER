...
public class ProposalController {
    ...
    public ApiResponse<ProposalResponse> initProposal(
            @PathVariable("memberId") Long memberId,
    ...
    public ApiResponse<ProposalResponse> saveProjectTemp(
    ...
    public ApiResponse<ProposalResponse> saveProjectFinal(
            @PathVariable("proposalId") Long proposalId,
    ...
    public ApiResponse<ProposalResponse> acceptDeal(
            @PathVariable("proposalId") Long proposalId,
    ...
    public ApiResponse<ProposalResponse> rejectDeal(
            @PathVariable("proposalId") Long proposalId,
            @RequestParam(required = false) ProposalBidStatus proposalBidStatus
    ) {
